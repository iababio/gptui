...
import CardBoxComponentTitle from '../components/admin/CardBox/Component/Title';
import CardBoxModal from '../components/admin/CardBox/Modal';
import Divider from '../components/admin/Divider';
import FormCheckRadio from '../components/admin/Form/CheckRadio';
import FormCheckRadioGroup from '../components/admin/Form/CheckRadioGroup';
import NotificationBar from '../components/admin/NotificationBar';
import PillTag from '../components/admin/PillTag';
...
const UiPage = () => {
  ...
  return (
    <>
      ...
      <Formik initialValues={{ outline: false }} onSubmit={()  => console.log("")}>
        {({ values }) => (
          <>
            <SectionTitle custom>
