...
export const PromptFolders = () => {
  ...
  const PromptFolders = (
    ...
    handleUpdatePrompt: any,
    handleDeletePrompt: any,
    handleCreatePublicPrompt: any,
    handleAddItem: any,
        ...
        {folders
          ...
          .map((folder, index) => (
            <Folder
              ...
              folderComponent={prompts
                .filter((p) => p.folderId)
                .map((prompt, index) => {
                  if (prompt.folderId === folder.id) {
                    const canEditPrompt =
                      isAdminUser || prompt.userId === session.data?.user?._id;
                    return (
        ...
        <>
          <Folder
            ...
            folderComponent={PromptFolders(
              ...
              null,
              undefined,
              isAdminUser ? handleEditPublicFolder : undefined,
              isAdminUser ? handleDeletePublicFolder : undefined,
              undefined,
              false,
              false,
            )}
